...
import (
	...
	_init_ "github.com/smartcontractkit/chainlink-testing-framework/lib/k8s/imports/k8s/podchaos/chaosmeshorg/jsii"

	"github.com/aws/constructs-go/constructs/v10"
	"github.com/cdk8s-team/cdk8s-core-go/cdk8s/v2"

	"github.com/smartcontractkit/chainlink-testing-framework/lib/k8s/imports/k8s/podchaos/chaosmeshorg/internal"
)
...
func (j *jsiiProxy_PodChaos) AddJsonPatch(ops ...cdk8s.JsonPatch) {
	args := []interface{}{}
	for _, a := range ops {
		args = append(args, a)
	}
...
func (j *jsiiProxy_PodChaos) ToString() *string {
	var returns *string
