...
var (
	...
	EthereumMainnet blockchain.EVMNetwork = blockchain.EVMNetwork{
		...
		Timeout:                   ctf_time.StrDuration{Duration: 5 * time.Minute},
		MinimumConfirmations:      1,
	...
	KlaytnMainnet blockchain.EVMNetwork = blockchain.EVMNetwork{
		...
		Simulated:                 false,
		ChainlinkTransactionLimit: 5000,
		Timeout:                   ctf_time.StrDuration{Duration: time.Minute},
		MinimumConfirmations:      1,
		GasEstimationBuffer:       0,
	}
	...
	OptimismMainnet blockchain.EVMNetwork = blockchain.EVMNetwork{
		...
		Simulated:                 false,
		ChainlinkTransactionLimit: 5000,
		Timeout:                   ctf_time.StrDuration{Duration: 3 * time.Minute},
		MinimumConfirmations:      0,
		GasEstimationBuffer:       0,
		FinalityTag:               true,
		DefaultGasLimit:           6000000,
