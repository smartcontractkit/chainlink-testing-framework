...
var (
	...
	SimulatedEVMNonDev1 = blockchain.EVMNetwork{
		...
		Timeout:                   utils_json.StrDuration{Duration: 2 * time.Minute},
	...
	EthereumMainnet blockchain.EVMNetwork = blockchain.EVMNetwork{
		...
		Timeout:                   utils_json.StrDuration{Duration: 5 * time.Minute},
		MinimumConfirmations:      1,
	...
	KlaytnMainnet blockchain.EVMNetwork = blockchain.EVMNetwork{
		...
		Simulated:                 false,
		ChainlinkTransactionLimit: 5000,
		Timeout:                   utils_json.StrDuration{Duration: time.Minute},
		MinimumConfirmations:      1,
		GasEstimationBuffer:       0,
	}
	...
	OptimismMainnet blockchain.EVMNetwork = blockchain.EVMNetwork{
		...
		Simulated:                 false,
		ChainlinkTransactionLimit: 5000,
		Timeout:                   utils_json.StrDuration{Duration: 3 * time.Minute},
		MinimumConfirmations:      0,
		GasEstimationBuffer:       0,
		FinalityTag:               true,
		DefaultGasLimit:           6000000,
