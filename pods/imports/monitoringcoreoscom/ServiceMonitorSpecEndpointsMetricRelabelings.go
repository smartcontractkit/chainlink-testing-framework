...
type ServiceMonitorSpecEndpointsMetricRelabelings struct {
	// Action to perform based on the regex matching.
	//
	// `Uppercase` and `Lowercase` actions require Prometheus >= v2.36.0. `DropEqual` and `KeepEqual` actions require Prometheus >= v2.41.0.
	// Default: "Replace".
	Action ServiceMonitorSpecEndpointsMetricRelabelingsAction `field:"optional" json:"action" yaml:"action"`
