...
// DefaultSetup setup minimum required components for test
func DefaultSetup(initFunc client.BlockchainNetworkInit) (*DefaultSuiteSetup, error) {

}

func setup(initFunc client.BlockchainNetworkInit, nodeCount int) (*DefaultSuiteSetup, error) {
	...
	env, err := environment.NewBasicEnvironment("default-setup", nodeCount, networkConfig)
	if err != nil {
		return nil, err
	}
