...
const (
	...
	BaseClientImplementation     ClientImplementation = "Base"
)
...
func wrapSingleClient(networkSettings EVMNetwork, client *EthereumClient) EVMClient {
	...
	case BaseClientImplementation:
		wrappedEc = &BaseClient{client}
	default:
		wrappedEc = client
	}
	return wrappedEc
...
func wrapMultiClient(networkSettings EVMNetwork, client *EthereumMultinodeClient) EVMClient {
	...
	case BaseClientImplementation:
		logMsg.Msg("Using Base Client")
		wrappedEc = &BaseMultinodeClient{client}
	default:
