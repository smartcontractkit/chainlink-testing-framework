...
func (b *BTTCClient) EstimateGas(callData ethereum.CallMsg) (GasEstimations, error) {
...
func (b *BTTCClient) DeployContract(
	contractName string,
...
func (b *BTTCClient) TransactionOpts(from *EthereumWallet) (*bind.TransactOpts, error) {
