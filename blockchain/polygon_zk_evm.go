...
func (p *PolygonZkEvmClient) Fund(toAddress string, amount *big.Float, gasEstimations GasEstimations) error {
...
func (p *PolygonZkEvmClient) DeployContract(
	contractName string,
...
// Fund sends some ETH to an address using the default wallet
func (p *PolygonZkEvmClient) ReturnFunds(fromPrivateKey *ecdsa.PrivateKey) error {
