...
[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/smartcontractkit/integrations-framework)](https://github.com/smartcontractkit/integrations-framework/tags)
...
See the [docs](https://smartcontractkit.github.io/integrations-framework/) or our [go reference](https://pkg.go.dev/github.com/smartcontractkit/integrations-framework) page for more detailed info and examples.
