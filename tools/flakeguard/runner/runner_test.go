...
func TestAttributePanicToTest(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:             "failed to attribute panic",
			expectedTestName: "",
			expectedTimeout:  false,
			outputs: []string{
				...
				"github.com/smartcontractkit/chainlink-solana/pkg/solana.NewContractReaderService({0x7fcf8b532040?, 0xc015b223e0?}, {0xc6ac960, 0xc05464e470}, {0xc0544384e0?, {0xc01c37d440?, 0xc054163b84?, 0xc054163b80?}}, {0x7fcf8071c7a0, 0xc0157928c0})",
