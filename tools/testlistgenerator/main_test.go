...
func TestMainFunction(t *testing.T) {
	...
	t.Run("InvalidDockerImageFormat", func(t *testing.T) {
		resetEnv()
		os.Args = []string{"main", OutputFile, "ocr", "TestOCR.*", "./smoke/ocr_test.go", "besu", "hyperledger/besu"}
	...
	t.Run("AppendToFile", func(t *testing.T) {
		...
		os.Args = []string{"main", OutputFile, "ocr", "TestOCR.*", "./smoke/ocr_test.go", "geth", "ethereum/client-go:1.10.0"}
		require.NotPanics(t, func() { main() })
	...
	t.Run("OverwriteFile", func(t *testing.T) {
		...
		os.Args = []string{"main", OutputFile, "ocr", "TestOCR.*", "./smoke/ocr_test.go", "besu", "hyperledger/besu:22.0.0,hyperledger/besu:23.0.0"}
		require.NotPanics(t, func() { main() })
	...
	t.Run("EmptyOutputFileName", func(t *testing.T) {
		resetEnv()
		os.Args = []string{"main", "", "ocr", "TestOCR.*", "./smoke/ocr_test.go", "besu", "hyperledger/besu:21.0.0"}
		require.PanicsWithError(t, fmt.Sprintf(EmptyParameterErr, "output_file_name"), func() { main() })
	})

	t.Run("EmptyProduct", func(t *testing.T) {
		resetEnv()
		os.Args = []string{"main", OutputFile, "", "TestOCR.*", "./smoke/ocr_test.go", "besu", "hyperledger/besu:21.0.0"}
		require.PanicsWithError(t, fmt.Sprintf(EmptyParameterErr, "product"), func() { main() })
	})

	t.Run("EmptyTestRegex", func(t *testing.T) {
		resetEnv()
		os.Args = []string{"main", OutputFile, "ocr", "", "./smoke/ocr_test.go", "besu", "hyperledger/besu:21.0.0"}
		require.PanicsWithError(t, fmt.Sprintf(EmptyParameterErr, "test_regex"), func() { main() })
	})

	t.Run("InvalidTestRegex", func(t *testing.T) {
		resetEnv()
		os.Args = []string{"main", OutputFile, "ocr", "[invalid", "./smoke/ocr_test.go", "besu", "hyperledger/besu:21.0.0"}
	...
	t.Run("EmptyFile", func(t *testing.T) {
		resetEnv()
		os.Args = []string{"main", OutputFile, "ocr", "TestOCR.*", "", "besu", "hyperledger/besu:21.0.0"}
		require.PanicsWithError(t, fmt.Sprintf(EmptyParameterErr, "file"), func() { main() })
	})

	t.Run("EmptyEthImplementation", func(t *testing.T) {
		resetEnv()
		os.Args = []string{"main", OutputFile, "ocr", "TestOCR.*", "./smoke/ocr_test.go", "", "hyperledger/besu:21.0.0"}
	...
	t.Run("EmptyDockerImages", func(t *testing.T) {
		resetEnv()
		os.Args = []string{"main", OutputFile, "ocr", "TestOCR.*", "./smoke/ocr_test.go", "besu", ""}
