...
func TestBasicPassAndFail(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected:      "📦\x1b[0;31mgithub.com/smartcontractkit/chainlink/integration-tests/smoke46.425s\x1b[0m::group::\x1b[0;31mTestAutomationNodeUpgrade\x1b[0m\x1b[90m00:07:20.32\x1b[0m\x1b[32mINF\x1b[0mReadingconfigsfromfilesystem::endgroup::::group::\x1b[0;31mTestAutomationNodeUpgrade/registry_2_0\x1b[0m[signalSIGSEGV:segmentationviolationcode=0x1addr=0xd8pc=0x5ab986f]::endgroup::",
			onlyErrors:    true,
			singlePackage: false,
		},
		{
			...
			expected:      "::group::\x1b[0;31m❌TestGetImage2(0.00s)\x1b[0mefgnothingtoseehere::endgroup::",
			onlyErrors:    true,
			singlePackage: true,
		},
		{
			...
			expected:   "📦\x1b[0;31mgithub.com/jmank88/gotest/c1.005s\x1b[0m::group::\x1b[0;31m❌TestC(1.00s)\x1b[0mpanic:testpanic[recovered]::endgroup::\x1b[0;31mTestLong\x1b[0m",
			onlyErrors: true,
		},
	}
