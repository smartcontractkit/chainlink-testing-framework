    ...
    AggregatorV2V3Interface
{
    ...
    mapping(address /* transmitter address */ => Transmitter)
   ...
   */
    ...
    function setValidatorConfig(
        ...
        if (
            previous.validator != newValidator ||
            previous.gasLimit != newGasLimit
        ) {
    ...
    function transmit(
        ...
        require(
            s_latestConfigDigest == reportContext[0],
        ...
        int192 juelsPerFeeCoin = _report(
            hotVars,
            reportContext[0],
            epochAndRound,
            report
    ...
    function _report(
        ...
        require(
            report.observations.length <= maxNumOracles,
            "num observations out of bounds"
        );
        require(
            hotVars.f < report.observations.length,
        ...
        )
    {
        ...
        Transmission memory transmission = s_transmissions[
    ...
    function setLinkToken(
        ...
        require(
            oldLinkToken.transfer(recipient, remainingBalance),
            "transfer remaining funds failed"
        );
    ...
    function _payOracle(address transmitterAddress) internal {
        ...
        if (juelsAmount > 0) {
            ...
            // control flow.
            require(
                s_linkToken.transfer(payee, juelsAmount),
                "insufficient funds"
            );
