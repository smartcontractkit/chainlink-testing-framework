...
func (e *EthereumOCRv2) SetValidatorConfig(flaggingThreshold uint32, validator OCRv2DeviationFlaggingValidator) error {
	panic("implement me")
}

func (e *EthereumOCRv2) SetBilling(price uint32, controller OCRv2AccessController) error {
	panic("implement me")
}
